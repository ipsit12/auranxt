                        ...
                        <div class="main-menu">
                            <nav>
                                <ul>
                                    ...
                                    <li class="mega-menu-position top-hover"><a href="shop"> SHOP <i class="fa fa-angle-down"></i> </a>
                                        <ul class="mega-menu">
                                            <li>
                                                <ul>
                                                    <li class="mega-menu-title"><a href="#">Categories 01</a></li>
                                                    <li><a href="shop">bag</a></li>
                                                    <li><a href="shop">Pen</a></li>
                                                    <li><a href="shop">Erasers</a></li>
                                                    <li><a href="shop">Glue sticks</a></li>
                                                    <li><a href="shop">Lunchbox </a></li>
                                                    <li><a href="shop">Pencil box </a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <ul>
                                    ...
                                    <li><a href="#"> PAGES <i class="fa fa-angle-down"></i> </a>
                                        <ul class="submenu">
                                            <li><a href="course">course page</a></li>
                                    ...
                                    <li><a href="course"> COURSES / PROGRAMMES</a></li>
                            ...
                            <div class="cart-wrap">
                                ...
                                <div class="shopping-cart-content">
                                    ...
                                    <div class="shopping-cart-btn">
                                        <a class="default-btn btn-hover" href="cart">view cart</a>
                                        <a class="default-btn btn-hover" href="checkout">checkout</a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="course-slider-active-3">
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details"><img class="animated" src="assets/img/course/course-1.jpg" alt=""></a>
                    <span>Addmission Going On</span>
                </div>
                <div class="course-content">
                    <h4><a href="course-details">Apparel Manufacturing</a></h4>
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details"><img class="animated" src="assets/img/course/course-2.jpg" alt=""></a>
                </div>
                <div class="course-content">
                    <h4><a href="course-details">Grphic Design & Multimedia</a></h4>
                    <p>magna aliqua. Ut enim ad minim veniam, nisi ut aliquiptempor incid.</p>
                </div>
                <div class="course-position-content">
                    <div class="credit-duration-wrap">
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details"><img class="animated" src="assets/img/course/course-3.jpg" alt=""></a>
                </div>
                <div class="course-content">
                    <h4><a href="course-details">Computer  Engineering</a></h4>
                    <p>magna aliqua. Ut enim ad minim veniam, nisi ut aliquiptempor incid.</p>
                </div>
                <div class="course-position-content">
                    <div class="credit-duration-wrap">
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details"><img class="animated" src="assets/img/course/course-4.jpg" alt=""></a>
