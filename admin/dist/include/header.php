  ...
  <div class="sidebar sidebar-dark sidebar-fixed" id="sidebar">
    <div class="sidebar-brand d-none d-md-flex">
      <svg class="sidebar-brand-full" width="118" height="46" alt="">
        <use xlink:href="assets/img/CS-Logo Final Filkes-01.png"></use>
      </svg>
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
      ...
      <li class="nav-item"><a class="nav-link" href="admissiondetails.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg>Admission Details</a></li>
          <li class="nav-item"><a class="nav-link" href="contactenquiery.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg>Contact Enquiry </a></li>
          <li class="nav-item"><a class="nav-link" href="jobportal.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg>Job Portal </a></li>
          <li class="nav-item"><a class="nav-link" href="enquirydetails.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg>Enquiry Services</a></li>
          <li class="nav-item"><a class="nav-link" href="enquirycourse.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg>Enquiry Course</a></li>
          <li class="nav-item"><a class="nav-link" href="Bhubaneswar_Enquiery.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg> Bhubaneswar Enquiry </a></li>
          <li class="nav-item"><a class="nav-link" href="Berhmapur_Enquiery.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg> Berhampur Enquiry </a></li>
          <li class="nav-item"><a class="nav-link" href="gallerydetails.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg>Image</a></li>
          <li class="nav-item"><a class="nav-link" href="videodetails.php">
          <svg class="nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-pencil"></use>
          </svg>Video</a></li>
      ...
      <div class="container-fluid">
        ...
        <ul class="header-nav ms-3">
          <li class="nav-item dropdown"><a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
              <div class="avatar avatar-md"><img class="avatar-img" src="../../images/newimage/logo.png" alt="user@email.com" style="width:100%"></div>
            </a>
