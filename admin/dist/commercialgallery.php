...
<table class="table ">
  ...
  <?php
    $count=0;
    $sql="SELECT * FROM commercial_house";
    ...
    ?>
      ...
      <td><a onclick="return confirm('do u want to delete?')" href="commercialdlt.php?x=<?php echo $id;?>"><i class="fa-solid fa-trash text-danger"></i></a></td>
    </tr>
