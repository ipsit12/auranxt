...
<table class="table ">
  ...
  <?php
    $count=0;
    $sql="SELECT * FROM residential_house";
    ...
    ?>
      ...
      <td><?php echo $name;?></td>
      <td><img src="../../gallery_image/<?php echo $a_name;?>" width="50px"alt=""></td>
      ...
      <td><a onclick="return confirm('do u want to delete?')" href="residentialdlt.php?x=<?php echo $id;?>"><i class="fa-solid fa-trash text-danger"></i></a></td>
    </tr>
