...
if (isset($_POST['submit'])) {
    ...
    if ($r_type == 'image/jpg' || $r_type == 'image/jpeg' || $r_type == 'image/png' || $r_type == 'image/gif' || $r_type == 'image/webp'|| $r_type == 'image/psd') {
...
<table class="table ">
  ...
  <?php
    ...
    ?>
      ...
      <td><img src="gallery_image/<?php echo $a_name;?>" width="100px"alt=""></td>
     
      
      <td><a onclick="return confirm('do u want to delete?')" href="gallerydlt.php?x=<?php echo $id;?>"><i class="fa-solid fa-trash text-danger"></i></a></td>
    </tr>
