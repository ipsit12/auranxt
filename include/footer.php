                    ...
                    <div class="footer-widget negative-mrg-30 mb-40">
                        ...
                        <div class="footer-list">
                            <ul>
                                ...
                                <li><a href="#">Ayurveda Therapist </a></li>
                                <li><a href="#">Professional Development </a></li>
                                <li><a href="#">Asethetics</a></li>
                    ...
                    <div class="footer-widget mb-40">
                        ...
                        <div class="f-contact-info">
                                <div class="single-f-contact-info">
                                    ...
                                    <span> Mallick commercial complex, Unit 3, Near hotel HHI,Kharvel Nagar,
Bhubaneswar; 751001</span>
                                </div>
                                <div class="single-f-contact-info">
                                    <i class="fa fa-envelope-o"></i>
                                    <span><a href="#">aurasalonacademy.bbsr@gmail.com</a></span>
                                </div>
                                <div class="single-f-contact-info">
                                    <i class="fa fa-phone"></i>
                                    <span> 7008797750</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="footer-menu-social">
                        ...
                        <div class="footer-social">
                            <ul>
                                <li><a class="facebook" href="https://www.facebook.com/auraacademysalon?mibextid=ZbWKwL"><i class="fa fa-facebook"></i></a></li>
                                <li><a class="" href="https://www.instagram.com/aura_nxt_skills_academy?utm_source=qr&igsh=d3kyMWFlb3RmdWcw"><i class="fa fa-instagram"></i></a></li>
