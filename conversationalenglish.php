        ...
        <div class="course-slider-active-3">
            ...
            <div class="single-course">
                <div class="course-img mx-3">
                    <a href="course-details"><img class="animated" src="http://kallaline.com/kallalinelanguagecenter/wp-content/uploads/2016/05/english_conversation.jpg" alt=""height="500px"></a>
                    <span>Addmission Going On</span>
                </div>
                <div class="course-content">
                    <h4 style="color:green;font-size:30px;">CONVERSATIONAL ENGLISH</a></h4>
            ...
            <div class="single-course">
                <div class="course-img">
                    <a href="course-details"><img class="animated" src="https://i.ytimg.com/vi/Z3VRSx7aO2A/maxresdefault.jpg" alt=""height="500px"></a>
                    <span>Addmission Going On</span>
                </div>
                <div class="course-content">
                    <h4 style="color:green;font-size:30px;">CONVERSATIONAL ENGLISH</a></h4>
